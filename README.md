...
- The source video analysis job uses `gemini-2.5-flash-lite` by default via `VIDEO_MODEL`, because it has been more reliable for short source-video analysis in this workflow than the heavier Pro model.
