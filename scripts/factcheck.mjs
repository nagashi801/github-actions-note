...
const system = [
  ...
  'Every level-2 and level-3 section needs one visual article illustration. Keep or update one imagePrompt for every section. These are decorative article images, not proof of actual production work.',
