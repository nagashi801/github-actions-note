...
const system = [
  ...
  'Every level-2 and level-3 section needs one visual article illustration. Include one vivid imagePrompt for every section, including small headings. These are decorative article images, not proof of actual production work.',
