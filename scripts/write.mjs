...
const system = [
  ...
  'Break long prompts by role, goal, scene, subject, action, camera, style, constraints, and negative instructions.',
  ...
  'Do not create demoAssets for generated videos or workflow screenshots. Videos are inserted manually by the user.',
